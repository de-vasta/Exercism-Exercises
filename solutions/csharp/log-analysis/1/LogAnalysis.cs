...
public static string SubstringBetween(this string s, string startAfter, string endBefore) => s.Substring(s.IndexOf(startAfter) + startAfter.Length, s.IndexOf(endBefore) + 1 - endBefore.Length - startAfter.Length);
